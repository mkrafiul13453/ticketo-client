                    ...
                    {!loading && !success && (
                        <div className="py-8 flex flex-col items-center justify-center gap-4 text-center">
                            ...
                            <CardFooter className="justify-center pt-6">
                                <Button  href="/dashboard/events" className="bg-indigo-600 hover:bg-indigo-500 text-white font-bold h-11 px-6" radius="lg">
                                    Return to Events
                                </Button>
                            </CardFooter>
                        </div>
                        ...
                        <>
                            ...
                            <div className="gap-6 bg-slate-900/40 p-6 rounded-2xl border border-white/5">
                                <div className="space-y-3">
                                    <h3 className="text-white font-bold text-lg line-clamp-1">{session?.metadata?.eventTitle}</h3>
                                    ...
                                    <div className="flex justify-between items-center text-xs text-slate-400">
                                        ...
                                        <span className="text-green-400 font-extrabold">${Number(session?.metadata?.amount).toFixed(2)}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-xs text-slate-400">
                                        <span>Transaction ID:</span>
                                        <span className="text-indigo-400 font-semibold truncate max-w-[200px]">{session?.payment_intent?.id}</span>
                                    </div>
                                </div>
                            </div>
