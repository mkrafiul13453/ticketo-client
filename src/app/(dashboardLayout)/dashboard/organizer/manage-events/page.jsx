...
const MangeEvent = () => {
    ...
    return (
        <div>
            <DashboardHeading title="Manage Events" description="Manage your events here" />
            ...
            <EditEventModal   isModalOpen={isModalOpen} setIsModalOpen={setIsModalOpen} editingEvent={editingEvent}></EditEventModal>
            <DeleteEventModal isDeleteOpen={isDeleteOpen} setIsDeleteOpen={setIsDeleteOpen} id={deletedId}></DeleteEventModal>
        </div>
    );
};
